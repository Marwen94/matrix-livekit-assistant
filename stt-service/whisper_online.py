...
class FasterWhisperASR(ASRBase):
    ...
    def __init__(self, lan, modelsize=None, cache_dir=None, model_dir=None, logfile=sys.stderr, device="cpu", compute_type="int8"):
        self.logfile = logfile
        self.device = device
    ...
    def load_model(self, modelsize=None, cache_dir=None, model_dir=None):
        ...
        model = WhisperModel(model_size_or_path, device=self.device, compute_type=self.compute_type, download_root=cache_dir)
        return model
